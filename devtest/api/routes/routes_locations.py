...
route_path_locations = Blueprint("route_path_locations", __name__)


@route_path_locations.route('/locations', methods=['GET'])
...
@route_path_locations.route('/locations/<int:country_code>', methods=['GET'])
...
@route_path_locations.route('/locations/<int:panel_provider>', methods=['GET'])
